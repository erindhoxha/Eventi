...
import { Box, Button, Host, Text as MagnusText, ThemeProvider } from 'react-native-magnus';
          ...
          <View
            ...
            <View
              ...
              <Box flex={1} pt="lg" mx="lg">
                    ...
                    <Box>
                      <FlatList
                        ...
                        contentContainerStyle={{
                          paddingBottom: data?.data && data?.data.length > 0 ? 80 : 0,
                        }}
                        renderItem={({ item }) => (
                          <Box
                            key={item.id}
                ...
                {!data.data?.length && data.status !== 'loading' && (
                  <Box>
